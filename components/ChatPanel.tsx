  ...
  return (
    <div className={layoutClass}>
      ...
      >
        <section className="overflow-hidden rounded-xl border border-border bg-card shadow-sm">
          <div className="flex flex-col items-center">
            <button
              ...
              className="flex h-20 w-full flex-col items-center justify-center gap-2 text-muted-foreground transition-colors hover:bg-info-surface hover:text-primary"
              title="展开问答记录"
              aria-label="展开问答记录"
            >
        ...
        {!historyCollapsed && (
          <div className="absolute left-full top-0 z-40 w-[412px] pl-3">
            <div className="overflow-hidden rounded-xl border border-border bg-card text-foreground shadow-2xl">
              ...
              <div className="flex items-center justify-between rounded-md border border-border bg-muted/30 px-2.5 py-1.5 text-xs">
                ...
                {selected.size > 0 ? (
                  <button
                    ...
                    className="flex items-center gap-1 text-destructive transition-colors hover:text-destructive"
                  >
                  ...
                  <li
                    ...
                    className={`group flex min-h-14 items-center gap-2 rounded-lg px-2.5 py-2 transition-colors ${
                      activeRecordId === rec.id
                        ...
                        : "text-muted-foreground hover:bg-info-surface hover:text-foreground"
                    }`}
                  >
                    <input
                      type="checkbox"
                    ...
                    <button
                      ...
                      className="shrink-0 rounded-md p-1 text-muted-foreground opacity-70 transition-colors hover:bg-destructive-surface hover:text-destructive group-hover:opacity-100"
                      aria-label="删除该记录"
                      title="删除该记录"
                    >
      ...
      <div className="space-y-5">
        ...
        {/* 回答区 */}
        {error && (
          <div className="rounded-md border border-destructive/40 bg-destructive-surface p-3 text-sm text-destructive">
            {error}
          </div>
        )}
